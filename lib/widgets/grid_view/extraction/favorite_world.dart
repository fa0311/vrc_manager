...
class ExtractionFavoriteWorld extends ConsumerGridWidget {
  ...
  Widget normal(BuildContext context, WidgetRef ref, GridConfigNotifier config) {
    ...
    List<VRChatFavoriteWorld> sortedFavoriteWorld = sortWorlds(config, favoriteWorld) as List<VRChatFavoriteWorld>;

    return RenderGrid(
      width: 600,
      height: 130,
      physics: const NeverScrollableScrollPhysics(),
      itemCount: sortedFavoriteWorld.length,
      itemBuilder: (BuildContext context, int index) {
        VRChatFavoriteWorld world = sortedFavoriteWorld[index];
