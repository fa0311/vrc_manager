...
class GridModal extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    GridConfigNotifier config = ref.watch(gridConfigProvider);
    return Column(
      children: <Widget>[
        ...
        if (gridModalConfig.worldDetails)
          SwitchListTile(value: config.worldDetails, title: Text(AppLocalizations.of(context)!.worldDetails), onChanged: (bool e) => config.setWorldDetails(e)),
