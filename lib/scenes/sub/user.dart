...
final vrchatMobileUserProvider =
    FutureProvider.family<VRChatMobileUserData, String>((ref, userId) async {
  ...
  return VRChatMobileUserData(
      user: user, status: status, world: world, instance: instance);
});
...
class VRChatMobileUser extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    AsyncValue<VRChatMobileUserData> data =
        ref.watch(vrchatMobileUserProvider(userId));
          ...
          builder: (context, ref, child) {
            ...
            return data.when(
              ...
              error: (e, trace) {
                ...
                return ScrollWidget(
                  onRefresh: () =>
                      ref.refresh((vrchatMobileUserProvider(userId).future)),
                  child:
